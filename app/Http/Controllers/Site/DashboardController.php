...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $total_quantity_blood = Historic::sum('quantity_blood');


        $bloodCentersWithQuantity = BloodCenter::withSum('historics', 'quantity_blood')->get();
        ...
        return view('dashboard.index', [
            ...
            'total_quantity_blood' => $total_quantity_blood,
            'bloodCentersWithQuantity' => $bloodCentersWithQuantity
